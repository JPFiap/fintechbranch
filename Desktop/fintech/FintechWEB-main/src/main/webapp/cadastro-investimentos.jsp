		...
		<div class="row justify-content-center">
			<div class="col-xl-10">
				...
				<div class="card mt-50 mb-50">
					<div class="card-title mx-auto mb-3">Cadastrar Investimento</div>
					<form action= "investimento" method="post">
						<div>
							<label for="investimento">Investimento</label>
						</div>
						<div class="row row-1">
							<input id="investimento" name="investimento" type="text"
						...
						<div class="row row-1">
							<input id="tipo" name="tipo" type="text" placeholder="Renda Fixa">
						</div>
						<div>
							<label for="dtInvestimento">Data aplicação</label>
						</div>
						<div class="row row-1">
							<input id="dtInvestimento" name="dtInvestimento" type="text">
						</div>
						<button class="btn btn-success d-flex mx-auto">
							<b>Adicionar Investimento</b>
						</button>
					</form>
				</div>
			</div>
