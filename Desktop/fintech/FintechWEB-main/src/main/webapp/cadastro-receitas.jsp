		...
		<div class="row justify-content-center">
			<div class="col-xl-10">
				...
				<div class="card mt-50 mb-50">
					<div class="card-title mx-auto mb-3">Cadastrar Receitas</div>
					<form>
						<div>
							<label for="receita">Receita</label>
						</div>
						<div class="row row-1">
							<input id="receita" name="receita" type="text"
								placeholder="Receita">
						</div>
						<div>
						...
						<div class="row row-1">
							<input id="dtEntrada" name="dtEntrada" type="text">
						</div>

						<div>
							<label for="dsReceita">Descrição Receita</label>
						</div>
						<div class="row row-1">
							<input id="dsReceita" name="dsReceita" type="text">
						</div>
