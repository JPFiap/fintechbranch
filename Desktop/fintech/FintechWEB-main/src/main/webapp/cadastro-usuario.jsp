										...
										<form action="usuario" method="post" class="formCadastro">
											...
											<div class="form-group mb-5">
												<label for="password">Senha</label> <input id="password"
													...
													placeholder="Crie sua senha" class="form-control" required>
											</div>
											...
											<p class="text-white text-center mt-3 mb-0">
												Já tem conta? <a href="login.jsp" class="text-primary ml-1">Clique
													aqui</a>
											</p>
										</form>
									</div>
								...
								<div class="col-lg-6 d-none d-lg-inline-block">
									<div class="account-block rounded-right">
										...
										<div class="account-testimonial">
											...
											<p class="lead text-white">Cadastre-se e descubra uma
												nova forma de organizar suas finanças</p>
